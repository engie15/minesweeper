...
// Define your `board` object here!
  ...
  var board = {}
  board.cells = [{row: 1, col: 0, isMine: false, hidden: true, isMarked: false, surroundingMines: [1]}, 
    ...
    {row: 2, col: 0, isMine: false, hidden: true, isMarked: false, surroundingMines: [1]}, 
    {row: 2, col: 1, isMine: false, hidden: true, isMarked: false, surroundingMines: [1]}, 
    {row: 2, col: 2, isMine: false, hidden: true, isMarked: false, surroundingMines: [1]}]
